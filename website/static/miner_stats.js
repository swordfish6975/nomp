...
function updateStats() {
	...
	var _blocktime = 50;
	var _networkHashRate = parseFloat(statData.networkHashs) * 1.2;
	...
	$("#statsTotalImmature").text(totalImmature.toFixed(2));
	$("#statsTotalBal").text(totalBal.toFixed(2));
	$("#statsTotalPaid").text(totalPaid.toFixed(2));
