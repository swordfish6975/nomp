...
module.exports = function(logger){
	...
	var buildUpdatedWebsite = function(){
		   ...
		   //logger.special(logSystem, 'result', result);
		   ...
		   logger.special(logSystem, 'buildUpdatedWebsite', 'live');
    };
	
	setInterval(buildUpdatedWebsite, (websiteConfig.stats.updateInterval + 100) * 1000);
